//==============================================================================
// Module: aes_ctr_decrypt
// Description: AES-128 CTR mode decryption
            ...
            case (state)
                IDLE: begin
                    ...
                    if (start) begin
                        ...
                        // Prepare to encrypt counter block (same as encryption)
                        // Key = SESSION_KEY
                        // Data = {COUNTER, 96'b0}
                        aes_key <= session_key;
                ...
                XOR_DATA: begin
                    // CTR mode: Plaintext = Ciphertext XOR Keystream
                    // (Same operation as encryption - CTR is symmetric)
                    plaintext <= ciphertext_reg ^ keystream;
                    state <= FINISH;
                end
